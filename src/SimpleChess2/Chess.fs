...
module Chess =
    ...
    type Direction = UpDown | RightLeft
    ...
    type chessPiece ( color : Color ) =
        ...
        member this.color with get() = color // White, Black
        member this.position
            with get() = _position
            and set(pos) = _position <- pos
        member this.x with get() = snd _position.Value
        member this.y with get() = fst _position.Value
                ...
                match (i,j) with
                    ...
                    | _ ->
                        ...
                        | (i,j) ->
                            ...
                            str + boardStr i (j+1)
            let firstRow = "    a   b   c   d   e   f   g   h\n"
            firstRow + (boardStr 0 0) + "\b\b"
